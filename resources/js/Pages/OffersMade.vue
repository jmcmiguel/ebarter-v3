<template>
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Offer's Made</h2>
        </template>
        ...
        <confirmation-modal :show="showingCancelOffer">
            ...
            <template #content>
                <p>Are you sure you want to cancel your offer? The offeree won't be able to see
                    it anymore.
                </p>
            </template>

            <template #footer>
                <secondary-button @click="closeCancelOffer">
                    Cancel
                </secondary-button>

                <danger-button class="ml-2" @click="cancelOffer()" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Confirm
                </danger-button>
            </template>
        </confirmation-modal>
