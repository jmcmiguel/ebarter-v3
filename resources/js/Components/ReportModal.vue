<template>
    <jet-dialog-modal :show="showingReportModal" @close="closeReportModal">
        <template #title>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">File a report</h2>
        </template>
            ...
            Please enter all the details required so we can process your report.
                ...
                <div class="mt-4 flex flex-col justify-center">
                    ...
                    <select class="mt-1 block w-full border-gray-300 focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 rounded-md shadow-sm" 
                        ...
                        <option v-for="(option, index) in reportOptions" v-bind:value="option.value" :key="index">
                            {{option.text}}
                        </option>
                    </select>
                ...
                <div class="mt-4 flex flex-col justify-center">
                    ...
                    <text-area rows="5" class="mt-1 block w-full" placeholder="Tell us why you reported"
                                id="report_desc"
                                ref="report_desc"
...
<script>
    ...
    export default {
        ...
        props: ['data', 'errors', 'showingReportModal', 'closeReportModal', 'reportData'],
