<template>
	...
	>
		...
		>
			<template v-for="(i, name) in this.$slots" #[name]="data">
				...
				<div :class="{ 'vac-messages-hidden': loadingMessages }">
					...
					<transition-group :key="roomId" name="vac-fade-message" tag="span">
						<div v-for="(m, i) in messages" :key="m.indexId || m._id">
							...
							>
								<template v-for="(idx, name) in this.$slots" #[name]="data">
									<slot :name="name" v-bind="data" />
								</template>
							</message>
						</div>
...
import SvgIcon from '@/Components/Chat/SvgIcon'
import EmojiPicker from '@/Components/Chat/EmojiPicker'

import RoomHeader from '@/Components/Chat/RoomHeader'
import RoomMessageReply from '@/Components/Chat/RoomMessageReply'
import RoomUsersTag from '@/Components/Chat/RoomUsersTag'
import RoomEmojis from '@/Components/Chat/RoomEmojis'
