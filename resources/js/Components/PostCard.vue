    ...
    <div class="block bg-white shadow-md hover:shadow-xl rounded-lg">
      ...
      >
        <vueper-slide
          ...
          :key="image.id"
          :image="image.image"
          @click="showLighbox(index, images)"
        >
        </vueper-slide>
      </vueper-slides>
      ...
      <div class="flex justify-between">
        <div class="p-4 flex items-center text-sm text-gray-600">
          ...
          <span
            @click="this.$emit('show-feedbacks', feedback)"
          ...
          <dropup align="right" width="48" popupPosition="right-0">
            ...
            <template #content>
              <div v-if="user.id === authUser.id">
                ...
                <jet-dropdown-link
                  @click="showDeletePostModal(id, title)"
                  as="button"
                >
                  Delete Post
                </jet-dropdown-link>
                <jet-dropdown-link
                  @click="showOffersModal(id, title)"
                  as="button"
                >
                  View Offers
                </jet-dropdown-link>
              ...
              <div v-if="userID !== authUser.id">
                ...
                <jet-dropdown-link
                  @click="showReportModal(id, userID)"
                  as="button"
                >
                  Report Post
                </jet-dropdown-link>
